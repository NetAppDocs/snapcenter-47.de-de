...
+
** Daten auf primären ONTAP FAS oder AFF Systemen, die auf sekundäre Cloud Volumes ONTAP oder NetApp Private Storage Systeme repliziert werden
...
+
Weitere Informationen zu Windows-Cmdlets finden Sie unter https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["SnapCenter Software Cmdlet Referenzhandbuch"^].

+
Weitere Informationen zu UNIX-Befehlen finden Sie unter https://library.netapp.com/ecm/ecm_download_file/ECMLP2883301["SnapCenter Software Command Reference Guide"^].
