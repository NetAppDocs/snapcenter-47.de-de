...
* *image:../media/enable_ca_issues_icon.png["Problem-Symbol"]* Gibt an, dass das CA-Zertifikat weder aktiviert noch dem Plug-in-Host zugewiesen ist.
...
* *image:../media/enable_ca_undefined_icon.png["Ca-Symbol nicht fertig"]* Zeigt an, dass die Verbindungsinformationen nicht abgerufen werden konnten.
+
