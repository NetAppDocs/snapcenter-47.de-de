...
Aktivitätsbereich
 a| 
.. Nachdem Sie den Sicherungsvorgang gestartet haben, klicken Sie im Aktivitätsbereich auf * *image:../media/activity_pane_icon.gif["Aktivitätssymbol"], um die letzten fünf Vorgänge anzuzeigen.
