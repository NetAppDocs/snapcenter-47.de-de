...
image::../media/sco_resourcegroup_policy.gif[Richtlinie aus Ressourcengruppe hinzufügen]
...
.. Klicken Sie in der Spalte Configure Schedules auf * *image:../media/add_policy_from_resourcegroup.gif["Richtlinie aus Ressourcengruppe hinzufügen"], um den Überprüfungsplan für alle Zeitplantypen der Richtlinie zu konfigurieren.
