...
* *image:../media/enable_ca_issues_icon.png["Symbol „Ca-Probleme“"]* Gibt an, dass kein CA-Zertifikat aktiviert oder dem Plug-in-Host zugewiesen ist.
* *image:../media/enable_ca_good_icon.png["Ca gutes Symbol"]* Zeigt an, dass das CA-Zertifikat erfolgreich validiert wurde.
* *image:../media/enable_ca_failed_icon.png["Symbol „Ca fehlgeschlagen“"]* Zeigt an, dass das CA-Zertifikat nicht validiert werden konnte.
* *image:../media/enable_ca_undefined_icon.png["Ca nicht definiertes Symbol"]* Zeigt an, dass die Verbindungsinformationen nicht abgerufen werden konnten.
