...
image::../media/sc-F5-configure-workflow.gif[Konfigurieren Sie HA mit f5]
...
+
Weitere Informationen finden Sie unter https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["SnapCenter Software Cmdlet Referenzhandbuch"^].
