...
.. Klicken Sie in der Spalte *Configure Schedules* für die Richtlinie, die Sie konfigurieren möchten, auf * *image:../media/add_policy_from_resourcegroup.gif["Richtlinie aus Ressourcengruppe hinzufügen"].
