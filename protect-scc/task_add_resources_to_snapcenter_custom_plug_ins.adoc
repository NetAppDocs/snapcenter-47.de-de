...
+
Optional: Klicken Sie auf das image:../media/add_policy_from_resourcegroup.gif["Richtlinie aus Ressourcengruppe hinzufügen"] Symbol, um weitere Volumes, LUNs und qtrees von anderen Storage-Systemen hinzuzufügen.
